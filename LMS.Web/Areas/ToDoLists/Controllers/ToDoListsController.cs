...
namespace LMS.Web.Areas.Controllers
{
    [Area("ToDoLists")]
    [Authorize]
    public class ToDoListsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Task,Description,Status,Priority,Assgignee,Comments,Created,CompleteBy")] ToDoList toDoList)
        {
            bool isDuplicateFoundusername
                  = _context.ToDoList.Any(c => c.UserName == toDoList.UserName);
            ...
            {
                ModelState.AddModelError("UserName", "Email address that you have entered is wrong please provide valid one!! ");
            }
            return View(toDoList);
        }
